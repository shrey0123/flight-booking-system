...
con=sqlite3.Connection('flight2.db')
cur=con.cursor()
...
fr2=Frame()
fr2.pack()
Label(fr2,text="Project Submitted By:-",font=("algerian",38),compound="center",fg="Green").pack()
Label(fr2,text="SHREY(PES2UG21CS500) , HEEMAJ YADAV(PES2UG21CS198) , TIRTHRAJ BHALOIDIYA(PES2UG21CS118)",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
...
def airline():
    ...
    Label(root1,text="Select Pick Up Point",bg='black',font=("Bauhaus 93",14),fg="white").grid(row=2,column=1)
    ...
    Label(root1,text="Select Boarding Point",bg='black',font=("Bauhaus 93",14),fg="white").grid(row=3,column=1)
                 ...
                 def signin():
                     ...
                     def bookingportal():
                          ...
                          if a==[]:
                                ...
                                date = Entry(root4, width=15, font=("Bauhaus 93", 14),fg="Blue",command=date1)
